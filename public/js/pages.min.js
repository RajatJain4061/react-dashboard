!(function($) {
  ...
  (Pages.prototype.setUserOS = function() {
      ...
      var elem = $('.pg-colors').length
        ...
        rgb = (color = (elem.find('[data-color="' + color + '"]').length
          ...
          : $(
            ...
            ).appendTo(elem)).css('background-color')).match(
          /^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/
        );
      return (
    ...
    (Pages.prototype.initFormGroupDefault = function(context) {
      $('.form-group.form-group-default', context).click(function() {
        ...
        this.initFormGroupDefaultRun ||
          ($(
            'body'
          ).on('focus', '.form-group.form-group-default :input', function() {
          ...
          $(
            'body'
          ).on('blur', '.form-group.form-group-default :input', function() {
            $(this)
              .parents('.form-group')
              .removeClass('focused'),
              $(this).val()
    ...
    (Pages.prototype.reponsiveTabs = function() {
      $('[data-init-reponsive-tabs="dropdownfx"]').each(function() {
        ...
        for (
          ...
          '#' == tabRef && (tabRef = li.children('a').attr('data-target')),
        ...
        if (0 != hMenu.length) {
          ...
          if (
            ...
            if (((possibleLi -= extraLiHide), liCount > possibleLi))
              for (
                var wrapper = createWrapperLI(hMenu), i = possibleLi;
                i < liCount;
                i++
              ) {
                var currentLi = hMenu
          ...
          $(this)
            .select2({
              minimumResultsForSearch:
                'true' == $(this).attr('data-disable-search') ? -1 : 1,
            })
            .on('select2:open', function() {
              $.fn.scrollbar &&
                $('.select2-results__options').scrollbar({ ignoreMobile: !1 });
            });
        });
    }),
    ...
    (Pages.prototype.initListView = function(context) {
      $.fn.ioslist && $('[data-init-list-view="ioslist"]', context).ioslist(),
        $.fn.scrollbar &&
          $('.list-view-wrapper', context).scrollbar({ ignoreOverlay: !1 });
    }),
      ...
      $.validator &&
        $.validator.setDefaults({
            ...
            return (
              ...
              $.each(errorList, function(index, value) {
                ...
                $(value.element).popover({
                  ...
                  (parent = $(value.element).closest('.form-group')).addClass(
                    'has-error'
                  ),
          ...
          onfocusout: function(element) {
            ...
            $(element).valid() &&
              (parent.removeClass('has-error'), parent.next('.error').remove());
          },
          ...
          createOptionHTML = function(el) {
            ...
            return (
              !el.selectedOpt ||
                ...
                ((classes += 'cs-selected '), (this.foundSelected = !0)),
              el.getAttribute('data-class') &&
                (classes += el.getAttribute('data-class')),
              el.getAttribute('data-link') &&
                (link = 'data-link=' + el.getAttribute('data-link')),
              '' !== classes && (optclass = 'class="' + classes + '" '),
              '<li ' +
                optclass +
                link +
              ...
              case 13:
                ev.preventDefault(),
                  self._isOpen() &&
                    void 0 !== self.preSelCurrent &&
                    -1 !== self.preSelCurrent &&
                    (self._changeOption(), self._toggleSelect());
                break;
              case 27:
      ...
      return this.filter(':input').each(function() {
        ...
        data ||
          ...
          'string' == typeof option
            ? data[option]()
            : options.hasOwnProperty('value') && data.value(options.value);
      });
    }),
    ...
    var Notification = function(container, options) {
      ...
      function alignWrapperToContainer() {
        var containerPosition = self.container.position(),
          ...
          containerBottom =
            self.container.parent().height() - (containerTop + containerHeight),
          containerLeft = containerPosition.left,
          containerRight =
            self.container.parent().width() - (containerLeft + containerWidth);
            ...
            : 'circle' == self.options.style
              ? new function() {
                  ...
                  self.options.thumbnail &&
                    ...
                    self.options.title &&
                      (table +=
                        '<p class="bold">' + self.options.title + '</p>'),
                    (table +=
                      '<p>' + self.options.message + '</p></div></div>'),
                    (table += '</div>'),
                    self.options.showClose &&
                      ((table +=
  ...
  (function($) {
    ...
    ($.fn.card = function(option) {
        ...
        data || $this.data('pg.card', (data = new Card(this, options))),
          'string' == typeof option
            ...
            : options.hasOwnProperty('refresh')
              ...
              : options.hasOwnProperty('error') && data.error(options.error);
      });
    }),
      ...
      $(
        document
      ).on('click.pg.card.data-api', '[data-toggle="collapse"]', function(e) {
        var $this = $(this),
      ...
      $(
        document
      ).on('click.pg.card.data-api', '[data-toggle="close"]', function(e) {
        var $this = $(this),
          $target = $this.closest('.card');
        $this.is('a') && e.preventDefault(),
      ...
      $(
        document
      ).on('click.pg.card.data-api', '[data-toggle="refresh"]', function(e) {
        var $this = $(this),
          $target = $this.closest('.card');
        $this.is('a') && e.preventDefault(),
          $target.data('pg.card') && $target.card({ refresh: !0 });
      }),
      $(
        document
      ).on('click.pg.card.data-api', '[data-toggle="maximize"]', function(e) {
        var $this = $(this),
          $target = $this.closest('.card');
        $this.is('a') && e.preventDefault(),
  ...
  (function($) {
    ...
    var MobileView = function(element, options) {
      var self = this;
      return (
        (self.options = $.extend(!0, {}, $.fn.pgMobileViews.defaults, options)),
    ...
    (Parallax.VERSION = '1.0.0'),
      (Parallax.prototype.animate = function() {
        ...
        (scrollPos = $(this.options.scrollElement).scrollTop()),
          this.$coverPhoto.css({
            transform:
              'translateY(' + scrollPos * this.options.speed.coverPhoto + 'px)',
          }),
          this.$content.css({
            transform:
              'translateY(' + scrollPos * this.options.speed.content + 'px)',
          }),
      ...
      if (
        ...
        this.$element.bind('mouseenter mouseleave', function(e) {
          ...
          this.$pageContainer.bind('mouseover', function(e) {
            var menuClosedCSS =
              1 == _this.css3d ? 'translate3d(0, 0,0)' : 'translate(0, 0)';
            if ($.Pages.isVisibleSm() || $.Pages.isVisibleXs()) return !1;
            (void 0 !== e && $(e.target).parent('.page-sidebar').length) ||
              _this.$body.hasClass('menu-pin') ||
    ...
    ($.fn.sidebar = function(option) {
      return this.each(function() {
        var $this = $(this),
          ...
          options = 'object' == typeof option && option;
        data || $this.data('pg.sidebar', (data = new Sidebar(this, options))),
          'string' == typeof option && data[option]();
      });
    }),
      ...
      $(
        document
      ).on('click.pg.sidebar.data-api', '[data-toggle-pin="sidebar"]', function(
        e
      ) {
        $(this);
        return (
    ...
    ($.fn.search = function(option) {
      return this.each(function() {
        var $this = $(this),
          ...
          options = 'object' == typeof option && option;
        data || $this.data('pg.search', (data = new Search(this, options))),
          'string' == typeof option && data[option]();
      });
    }),
      ...
      $(
        document
      ).on('click.pg.search.data-api', '[data-toggle="search"]', function(e) {
        var $this = $(this),
